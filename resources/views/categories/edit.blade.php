                ...
                <form action="{{ route('categories.update', $category) }}" method="POST" enctype="multipart/form-data" class="relative z-10 space-y-8">
                    ...
                    <div>
                        ...
                        <input type="text" name="name" id="name"
                               ...
                               value="{{ old('name', $category->name) }}" required placeholder="Ej: Accesorios Vintage">
                        @error('name')
                    ...
                    <div>
                        ...
                        <p class="mt-1.5 text-sm text-[#E3BC9A]/75 italic">Puedes editar el nombre para regenerar el slug</p>
                    </div>
                    ...
                    <div>
                        ...
                        @else
                            <p class="text-[#E3BC9A]/70 italic">No hay imagen cargada actualmente.</p>
                        @endif
                    </div>
                    ...
                    <div class="flex flex-col sm:flex-row gap-6 justify-center mt-14">
                        <button type="submit"
                            ...
                            <i class="fas fa-save mr-3"></i> ACTUALIZAR
                        </button>
